...
Note: Lembre-se de acessar a [documentação](https://developers.vtex.com/docs/vtex-responsive-layout) do Responsive Layout caso tenha alguma dúvida durante a atividade.
  ...
  Confira [aqui o gabarito para esta etapa](https://vtex-enterprise-group.readme.io/learning/docs/course-layout-blocks-step04responsive-answersheet) ou peça ajuda a um de nossos monitores