...
> Certifique-se de testar também a ação de _hover_, de forma a validar se as cores para esta ação também estão corretas.
  ...
  Confira [aqui o gabarito para esta etapa](https://vtex-enterprise-group.readme.io/learning/docs/course-styles-course-step01csshandles-answersheet) ou peça ajuda a um de nossos monitores